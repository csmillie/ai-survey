...
import { cancelRunAction, exportRunAction, getResponseDebugData, setVerificationStatusAction } from "./actions";
...
export function RunProgressView({
  ...
  questionGroups.sort((a, b) => a.questionOrder - b.questionOrder);
...
function ResponseRow({
  ...
  return (
    <>
      <TableRow className={`cursor-pointer ${verificationBorderClass(response.verificationStatus)}`} onClick={onToggle}>
        <TableCell>
          <div className="flex items-center gap-1.5">
