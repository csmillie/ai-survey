...
export function computeReliabilityScore(
  ...
  if (n === 0) {
    return {
      ...
      costCv: 0,
      penaltyBreakdown: {
        jsonInvalid: PENALTY_WEIGHTS.jsonInvalid,
        emptyAnswer: PENALTY_WEIGHTS.emptyAnswer,
        shortAnswer: PENALTY_WEIGHTS.shortAnswer,
        missingCitations: PENALTY_WEIGHTS.missingCitations,
        latencyVariance: 0,
        costVariance: 0,
      },
      totalResponses: 0,
